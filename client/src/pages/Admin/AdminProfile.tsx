...
const AdminProfile: React.FC = () => {
  ...
  const uploadProfilePicture = async () => {
    ...
    try {
      ...
      const response = await apiService.post('/admin/upload-profile-picture', formData, {
        headers: {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await apiService.put('/admin/profile', updateData);
      setAdminData(response.data);
      setEditedData(response.data);
      setIsEditing(false);
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900">
                  {isEditing ? editedData.name : adminData.name}
                </h2>
                <p className="text-gray-600">{adminData.email}</p>
                <p className="text-sm text-gray-500 capitalize">{adminData.role}</p>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{new Date(adminData.createdAt).toLocaleDateString()}</p>
                </div>
              </div>
            </div>
          </div>
